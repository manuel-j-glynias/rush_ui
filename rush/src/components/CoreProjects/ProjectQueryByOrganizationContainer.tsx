...
import {Maybe,CoreProject, useCoreProjectListByOrganizationQuery} from '../../generated/graphql';
...
const ProjectQueryByOrganizationContainer : React.FC<Props> = ({search_string,selected_project,set_selected_project,set_selected_project_obj}: Props) => {


    const {data, error, loading, refetch} = useCoreProjectListByOrganizationQuery(
...
export default ProjectQueryByOrganizationContainer;
