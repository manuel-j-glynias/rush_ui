...
import {Maybe,CoreProject, useCoreProjectListByPiQuery} from '../../generated/graphql';
...
const ProjectQueryByPIContainer : React.FC<Props> = ({search_string,selected_project,set_selected_project,set_selected_project_obj}: Props) => {


    const {data, error, loading, refetch} = useCoreProjectListByPiQuery(
...
export default ProjectQueryByPIContainer;
