...
const TrialsByPhaseQueryContainer : React.FC<Props> = ({search_string,selected_trial,set_selected_trial,set_selected_trial_obj}:Props) => {

    const {data, error, loading, refetch} = useTrialListByPhaseQuery(
...
export default TrialsByPhaseQueryContainer;