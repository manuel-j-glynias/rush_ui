...
const TrialsByDrugQueryContainer : React.FC<Props> = ({search_string,selected_trial,set_selected_trial,set_selected_trial_obj}:Props) => {

    const {data, error, loading, refetch} = useTrialListByDrugQuery(
...
export default TrialsByDrugQueryContainer;